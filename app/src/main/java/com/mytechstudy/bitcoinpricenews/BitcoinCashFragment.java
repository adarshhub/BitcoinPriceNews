...
public class BitcoinCashFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {

    FirebaseDatabase database;
    TextView bchprice;
    SwipeRefreshLayout swipeRefreshLayout;
    ImageView bchup,bchdown;
    RecyclerView recyclerView;


    public BitcoinCashFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_bitcoin_cash, container, false);
        bchdown = view.findViewById(R.id.Bchdown);
        bchup = view.findViewById(R.id.Bchup);
        bchprice = view.findViewById(R.id.Bchprice);
        recyclerView = view.findViewById(R.id.Bchrecycleview);
        swipeRefreshLayout = view.findViewById(R.id.Bchswipe);
    ...
    private void initrecyclerView() {
        ...
        DatabaseReference newsRef = FirebaseDatabase.getInstance().getReference("Feed").child("BitcoinCash");
        ...
        newsRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                class BchNews extends RecyclerView.Adapter<MyViewHolder>{
                    List<News> list= new ArrayList<>();

                    BchNews(List<News> list)
                    {
                        this.list = list;
                ...
                BchNews bchNews = new BchNews(news);
                recyclerView.setAdapter(bchNews);
    ...
    public void priceincurrency(final String currency)
    {
        ...
        database.getReference("Coins").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET,  dataSnapshot.child("BCH").getValue()+"?convert="+currency, null, new Response.Listener<JSONArray>() {
                    @Override
