...
public class RippleFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {

    FirebaseDatabase database;
    TextView rippleprice;
    SwipeRefreshLayout swipeRefreshLayout;
    ImageView rippleup,rippledown;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rippledown = view.findViewById(R.id.xrpdown);
        rippleup = view.findViewById(R.id.xrpup);
        rippleprice = view.findViewById(R.id.xrpprice);
        recyclerView = view.findViewById(R.id.Ripplerecycleview);
        swipeRefreshLayout = view.findViewById(R.id.Rippleswipe);
        swipeRefreshLayout.setOnRefreshListener(this);
        swipeRefreshLayout.setRefreshing(true);
        database = FirebaseDatabase.getInstance();
        rippleup.setVisibility(View.INVISIBLE);
        rippledown.setVisibility(View.INVISIBLE);
    ...
    private void initrecyclerView() {
        ...
        DatabaseReference newsRef = database.getReference("Feed").child("Ripple");
        ...
        newsRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                class RippleNews extends RecyclerView.Adapter<MyViewHolder>{
                    List<News> list= new ArrayList<>();

                    RippleNews(List<News> list)
                    {
                        this.list = list;
                ...
                RippleNews rippleNews = new RippleNews(news);
                recyclerView.setAdapter(rippleNews);
    ...
    public void priceincurrency(final String currency)
    {
        ...
        database.getReference("Coins").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET,  dataSnapshot.child("XRP").getValue()+"?convert="+currency, null, new Response.Listener<JSONArray>() {
                    @Override
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            ...
                            rippleprice.setText(price);
                            if (jsonObject.getInt("percent_change_1h")<0)
                                rippledown.setVisibility(View.VISIBLE);
                            else
                                rippleup.setVisibility(View.VISIBLE);
