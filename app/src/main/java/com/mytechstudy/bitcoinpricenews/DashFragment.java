...
public class DashFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {

    FirebaseDatabase database;
    TextView dashprice;
    SwipeRefreshLayout swipeRefreshLayout;
    ImageView dashup,dashdown;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dashdown = view.findViewById(R.id.dashdown);
        dashup = view.findViewById(R.id.dashup);
        dashprice = view.findViewById(R.id.dhprice);
        recyclerView = view.findViewById(R.id.Dashrecycleview);
        swipeRefreshLayout = view.findViewById(R.id.Dashswipe);
    ...
    private void initrecyclerView() {
        ...
        DatabaseReference newsRef = FirebaseDatabase.getInstance().getReference("Feed").child("Dash");
        ...
        newsRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                class DashNews extends RecyclerView.Adapter<MyViewHolder>{
                    List<News> list= new ArrayList<>();

                    DashNews(List<News> list)
                    {
                        this.list = list;
                ...
                DashNews dashNews = new DashNews(news);
                recyclerView.setAdapter(dashNews);
    ...
    public void priceincurrency(final String currency)
    {
        ...
        database.getReference("Coins").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET,  dataSnapshot.child("DASH").getValue()+"?convert="+currency, null, new Response.Listener<JSONArray>() {
                    @Override
